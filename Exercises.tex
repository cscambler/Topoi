...
\end{ex}
\begin{proof}
    Let $f : \A \to \D$ be monic.
    First, it will be handy to have some identities. Note that
    ...
    \begin{equation}\label{help}
        \chi_f(d, p)  = \bigsqcup_{a \in A} f(a, d) \Leftrightarrow p
    \end{equation}
    which then implies
    \begin{equation}\label{id2}
        \chi_f \circ f(a, p)  = \bigsqcup_{d \in D} f(a, d) \wedge \bigsqcup_{a' \in A} f(a', d) \Leftrightarrow p
    \end{equation}
    putting \eqref{id1}, \eqref{id2} together, it suffices show 
    \begin{equation}\label{target}
        \lb Ea \rb \wedge p = \bigsqcup_{d \in D} f(a, d) \wedge \bigsqcup_{a' \in A} f(a', d) \Leftrightarrow p
    \end{equation}
    to show the square commutes.

    It is immediate that 
    \begin{equation}\label{help1}
        \bigsqcup_{d \in D} f(a, d) \wedge \bigsqcup_{a' \in A} f(a', d) \Leftrightarrow p = \bigsqcup_{d \in D} f(a, d) \wedge f(a, d) \Leftrightarrow p
    \end{equation}
    by algebra (lol) we get 
    \begin{equation}\label{help2}
        \bigsqcup_{d \in D} f(a, d) \wedge f(a, d) \Leftrightarrow p = \bigsqcup_{d \in D} f(a, d) \wedge p 
    \end{equation}
    but putting \eqref{help1} and \eqref{help2} together implies \eqref{target} by vii on p 277. 
\end{proof}
\end{document}